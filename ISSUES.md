...
|---|---|---|---|
| [#142](https://github.com/clement-igonet/mapmax/issues/142) | Auto-fix orientation: compare the vector-world equirect with the photo equirect | [#143](https://github.com/clement-igonet/mapmax/pull/143) (draft) | spin-scan builds a 360° band of the vector world, the pano is resampled into the same azimuth bins, circular correlation (skyline + edge features) proposes the yaw; live preview re-rolls the photo band on every angle change; local-only (#111) |
