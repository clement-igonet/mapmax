...
| [#46](https://github.com/clement-igonet/mapmax/issues/46) | Flat pictures as located patches | [#121](https://github.com/clement-igonet/mapmax/pull/121) (was #120) | flat photos enter the photosphere as an equirect patch at their capture heading/FOV (pinhole vfov, hairline frame, neutral backdrop); popup kept as CORS/decode fallback; works for Panoramax and Mapillary flats; flats get floor dots in the map's colors, with fair per-source slot reservation |
