...
|---|---|---|---|
| [#98](https://github.com/clement-igonet/mapmax/issues/98) | Pose corrector (pitch/roll/yaw) + Panoramax PATCH write-back | [#100](https://github.com/clement-igonet/mapmax/pull/100) (draft) | calibration UX validated by the user on [sandbox](https://sandbox.mapmax.confinia.io); panel-flicker fixed (compositor layer + debounced persistence, `8a264b9`) and redeployed; remaining: token write-back check |
