...
| [#107](https://github.com/clement-igonet/mapmax/issues/107) | Position edit mode: ⇧-drag on the ground (lat/lon) + eye-height ▲▼ | [#109](https://github.com/clement-igonet/mapmax/pull/109) (draft, stacked on #108) | ground-raycast grab, per-picture metre offsets, lat/lon rides in the pose PATCH; altitude local-only (no API field) |
