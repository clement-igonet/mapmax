...
| Issue | Title | Notes |
|---|---|---|
| [#139](https://github.com/clement-igonet/mapmax/issues/139) | Native flat projection (photosphere 0.5.0) replaces the flatpatch canvas | [#141](https://github.com/clement-igonet/mapmax/pull/141) (draft): pictureToTarget stamps `projection:'flat'`+`hfov`; flatpatch.js retired; untyped pics stay conservatively flat (#40); on sandbox for visual check |
