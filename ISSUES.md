...
| [#112](https://github.com/clement-igonet/mapmax/issues/112) | Multi-source 360° imagery (Mapillary, Commons, self-hosted, …) | [#116](https://github.com/clement-igonet/mapmax/pull/116) (draft) | **phase 1**: `src/sources.js` adapter registry extracted around the Panoramax flow (capability gating, cross-source searchNearby, read-only edit gate); no behavior change; next: Mapillary adapter per [SOURCES.md](SOURCES.md) |
