...
| Issue | Title | Notes |
|---|---|---|
| [#104](https://github.com/clement-igonet/mapmax/issues/104) | "Connect to Panoramax" (OAuth claim flow) — automate token retrieval | follow-up to #98; API claim flow confirmed |
