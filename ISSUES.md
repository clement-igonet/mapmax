...
| [#46](https://github.com/clement-igonet/mapmax/issues/46) | Flat pictures as located patches | [#120](https://github.com/clement-igonet/mapmax/pull/120) (draft, stacked on #116) | flat photos enter the photosphere as an equirect patch at their capture heading/FOV (pinhole vfov, hairline frame, neutral backdrop); popup kept as CORS/decode fallback; works for Panoramax and Mapillary flats; flats now get floor dots too, colored per source/type like the map (plugin setNavPois color, upstreamed) |
